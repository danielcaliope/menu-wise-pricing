-- Update alert trigger functions to use SECURITY INVOKER instead of SECURITY DEFINER
-- This prevents RLS bypass while still allowing users to create alerts for their own data
